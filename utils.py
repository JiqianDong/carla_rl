...
class World(object):
    ...
    def setup_vehicles(self):
        ...
        self.FHDV = self.world.spawn_actor(get_blueprint("FHDV",'bmw','128,128,128'), FHDV_spawn_point)
    ...
    def setup_sensors(self):
        ...
        self.camera_manager = CameraManager(self.CAV, self.hud)
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
            carla.Transform(carla.Location(x=-0.1,y=-0.1, z=1.2), carla.Rotation(pitch=-15)),
